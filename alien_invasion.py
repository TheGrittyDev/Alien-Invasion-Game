...
class AlienInvasion:
    ...
    def _check_play_button(self, mouse_pos):
        ...
        if not self.is_game_active and button_clicked:
            # Reset the game settings (speeds) 
    ...
    def _check_alien_bullet_collision(self):
        ...
        # Create a new fleet after old one has been destroyed
        if not self.aliens:
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            # Decrement ships left and update no of ships left on scoreboard
